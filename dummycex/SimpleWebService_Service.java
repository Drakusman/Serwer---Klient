 ...
 * 
 */
@WebServiceClient(name = "SimpleWebService", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/CEXWebService/SimpleWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/CEXWebService/SimpleWebService?wsdl");
